...
class ViolinTestCase(unittest.TestCase):
    ...
    def test_validate_score(self):
        ...
        float_cases = [
            ...
            [(['.', 2, 5],       [90.0, 98.0, 71.9]),             [3, 5, 10, 25], ('.25', 71.9)],
            [(['.', 7, 5],       [64.0, 92.0, 94.0]),             [3, 5, 10, 25], ('.75', 64.0)],
            [([0, '.', 5],       [97.0, 90.0, 98.0]),             [3, 5, 10, 25], ('0.5', 90.0)],
            [([1, '.', 5],       [96.0, 92.0, 98.0]),             [3, 5, 10, 25], ('1.5', 92.0)],
            [([2, '.', 2, 5],    [87.0, 91.0, 95.0, 99.0]),       [3, 5, 10, 25], ('2.25', 87.0)],
            [([9, '.', 7, 5],    [91.0, 99.0, 94.0, 93.0]),       [10, 25],       ('9.75', 91.0)],
            [([1, 0, '.', 5],    [93.4, 95.0, 96.0, 99.0]),       [25],           ('10.5', 93.4)],
            [([1, 5, '.', 2, 5], [85.6, 93.0, 89.0, 92.0, 91.0]), [25],           ('15.25', 85.6)],
            [([2, 4, '.', 5],    [90.0, 93.0, 89.0, 94.0]),       [25],           ('24.5', 89.0)],
        ]
